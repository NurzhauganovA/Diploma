...
class SubjectSection(models.Model):
    ...
    subject = models.ForeignKey(
        Subject, on_delete=models.CASCADE, null=False, db_column="subject"
    )
...
class SectionAction(models.Model):
    ...
    student = models.ForeignKey(
        "authorization.Student", on_delete=models.CASCADE, null=False
    )
    status = models.CharField(
        max_length=155,
        choices=SectionActionStatus.choices,
        default=SectionActionStatus.ATTENDED,
    )
